...
print('Welcome To Tic Tac Toe By Jeve Stobs')  #title
print('We have some music prepared for you')

exec(open("muzak.py").read())

while playgame == True:
    position = [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
                ' ']  #sets the board spaces blank
    plyr1list = []
    plyr2list = []
    gamelist = []
    ...
    name1 = input()
    print('thanks ' + (name1) + ', What is player 2s name?')
    name2 = input()
    ...
    while (movecount < 9) and (winner == False):
        ...
        if (movecount % 2 == 0):  #player 1 turn
            ...
            if move in ('1', '2', '3', '4', '5', '6', '7', '8',
                        '9') and (int(move) not in (gamelist)):
